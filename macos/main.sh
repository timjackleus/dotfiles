...
defaults write com.apple.Music dontAutoPlay -bool true
...
defaults write com.apple.applicationaccess.plist com.apple.diagnostic-submissions.allow -bool false
