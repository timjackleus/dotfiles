...
keymap({ "n", "v" }, "<leader>aa", "<cmd>lua require('vscode').action('workbench.action.toggleAuxiliaryBar')<CR>")
...
keymap({ "n", "v" }, "<C-p>", "<cmd>lua require('vscode').action('composer.selectPreviousComposer')<CR>")
...
keymap({ "n", "v" }, "<leader>aa", "<cmd>lua require('vscode').action('workbench.panel.aichat')<CR>")
